...
public class DataTypes2AvroGenerator {
    ...
    public static void main(String[] args) throws Exception {
        ...
        ByteBuffer bf = ByteBuffer.allocate("Hello World".getBytes().length).put("Hello World".getBytes(), 0, "Hello World".getBytes().length - 1);
        bf.flip();
        ...
        DataFileReader<DataTypes2> dataFileReader = new DataFileReader<DataTypes2>(new File("datatypes2.avro"), datumReader);
